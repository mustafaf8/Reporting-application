...
async function generateProposalPdf(req, res) {
  try {
    ...
    const aboutRmr = {
      ...
      closingStatement:
        "RMR Enerji ile güneşin gücünü işinize ve hayatınıza taşıyın. Temiz enerjiye geçiş yolculuğunuzda güvenilir çözüm ortağınız olmak için buradayız.",
    };
